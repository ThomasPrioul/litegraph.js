...
export class DragAndScale {
  ...
  convertOffsetToCanva(pos: Vector2) {
  ...
  changeScale(value: number, zooming_center?: Vector2) {
  ...
  changeDeltaScale(value: number, zooming_center?: Vector2) {
